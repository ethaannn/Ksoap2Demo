...
public class MonitorBean implements Serializable
{
    ...
    public int getAreaStatus() { return areaStatus;}

    public void setAreaStatus(int areaStatus) { this.areaStatus = areaStatus;}
    ...
    public int getAreaClassify() { return areaClassify;}

    public void setAreaClassify(int areaClassify) { this.areaClassify = areaClassify;}
    ...
    public void setLeaf(int leaf) { this.leaf = leaf;}
